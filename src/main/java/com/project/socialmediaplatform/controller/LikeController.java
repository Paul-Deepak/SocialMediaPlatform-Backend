...
public class LikeController {
    ...
    @PostMapping
    public ResponseEntity<Like> addLikeForPost( @PathVariable Long userId,@PathVariable String type, @PathVariable Long typeId) {
        if(type.equals("post")){
    ...
    @DeleteMapping
    public ResponseEntity<String> removeLikeForPost(@PathVariable Long userId,@PathVariable String type, @PathVariable Long typeId) {
        if(type.equals("post")){
